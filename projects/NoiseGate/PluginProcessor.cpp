...
static const std::vector<mrta::ParameterInfo> Parameters
{
    ...
    { Param::ID::Threshold,Param::Name::Threshold,Param::Units::Db,  -20.f,Param::Ranges::ThresholdMin,Param::Ranges::ThresholdMax,Param::Ranges::ThresholdInc,Param::Ranges::ThresholdSkw },
    { Param::ID::Ratio,    Param::Name::Ratio,    Param::Units::Db,  2.f,  Param::Ranges::RatioMin,    Param::Ranges::RatioMax,    Param::Ranges::RatioInc,    Param::Ranges::RatioSkw },
    { Param::ID::Attack,   Param::Name::Attack,   Param::Units::Ms,  5.f,  Param::Ranges::AttackMin,   Param::Ranges::AttackMax,   Param::Ranges::AttackInc,   Param::Ranges::AttackSkw },
    { Param::ID::Release,  Param::Name::Release,  Param::Units::Ms,  5.f,  Param::Ranges::ReleaseMin,  Param::Ranges::ReleaseMax,  Param::Ranges::ReleaseInc,  Param::Ranges::ReleaseSkw }
};
